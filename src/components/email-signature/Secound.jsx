...
function Secound({ name, email, job_title, phone_no, organization, logo, linkedin, instagram, twitter, facebook }) {
  ...
  const contacts = [
    {
      ...
      icon: (
        <img src="https://cdn-icons-png.flaticon.com/512/724/724664.png" width="50%" height="50%" style={{ display: "block" }} />
      ),
    },
    {
      href: `mailto:${email}`,
      ...
      icon: (
      <img src="https://cdn-icons-png.flaticon.com/512/561/561127.png" width="50%" height="50%" style={{ display: "block" }} />
      ),
    },
    {
      href: null,
      ...
      icon: (
       <img src="https://cdn-icons-png.flaticon.com/512/684/684908.png" width="50%" height="50%" style={{ display: "block" }} />
      ),
    },
  ];
  ...
  display: "block" }} />,
    ...
    {
      href: instagram, bg: "",
      icon: <img src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" width="50%" height="50%" style={{ display: "block"
  }} />,
    },
  ];
