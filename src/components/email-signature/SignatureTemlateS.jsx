        ...
        <tr>
                    ...
                    <table cellPadding="0" cellSpacing="0">
                      <tbody>
                        <tr>
                          ...
                          <td style={{ fontSize: "10px", color: "#555555", fontFamily: "Arial, sans-serif" }}>(021) 234-567 7890</td>
                        </tr>
                      </tbody>
                    </table>
                  </td>
                    ...
                    <table cellPadding="0" cellSpacing="0">
                      <tbody>
                        <tr>
                          ...
                          <td style={{ fontSize: "10px", color: "#555555", fontFamily: "Arial, sans-serif" }}>+880 1234-567890</td>
                        </tr>
                      </tbody>
                    </table>
                  </td>
                    ...
                    <table cellPadding="0" cellSpacing="0">
                      <tbody>
                        <tr>
                          ...
                          <td style={{ fontSize: "10px", color: "#555555", fontFamily: "Arial, sans-serif" }}>www.ExampleEmail.com</td>
                        </tr>
                      </tbody>
                    </table>
                  </td>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style={{ fontSize: "10px", color: "#555555", fontFamily: "Arial, sans-serif", lineHeight: "1.5" }}>
                            Your Street Address Here,<br />New York City, My 20-000
                          </td>
                        </tr>
                      </tbody>
                    </table>
          ...
          >
            ...
            <table cellPadding="0" cellSpacing="0" style={{ margin: "0 auto 16px auto" }}>
              <tbody>
                <tr>
                  <td style={{ border: "2px solid #1a2a4a", padding: "5px 16px", borderRadius: "4px" }}>
                    <p style={{ margin: "0", fontSize: "16px", fontWeight: "bold", color: "#1a2a4a", letterSpacing: "2px", fontFamily: "Arial, sans-serif" }}>
                      L<span style={{ color: "#4a90c4" }}>O</span>GO
                    </p>
                  </td>
                </tr>
              </tbody>
            ...
            <table cellPadding="0" cellSpacing="0" style={{ margin: "0 auto" }}>
              <tbody>
                <tr>
                  {[
                    <svg key="fb" width="10" height="10" viewBox="0 0 24 24" fill="white"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>,
                    <svg key="tw" width="10" height="10" viewBox="0 0 24 24" fill="white"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z" /></svg>,
                    <svg key="li" width="10" height="10" viewBox="0 0 24 24" fill="white"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z" /><circle cx="4" cy="4" r="2" fill="white" /></svg>,
                    <svg key="ig" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="0.8" fill="white" stroke="none" /></svg>,
                  ].map((icon, i) => (
                    <td key={i} style={{ paddingLeft: i === 0 ? "0" : "5px" }}>
