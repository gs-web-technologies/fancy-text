                        ...
                        <td>
                            ...
                            >
                                <tbody>
                                    ...
                                    <tr>
                                        {/* Photo Cell */}
                                        <td style={{ padding: "24px 16px 16px 24px", verticalAlign: "top", width: "110px" }}>
                                            <img
                                                src={imageSrc}
                                                alt="Johnathan Pope"
                                                style={{
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style={{ paddingRight: "8px" }}>
                                                            <a href={linkedin} style={{ textDecoration: "none" }}>
                                                                <table cellPadding="0" cellSpacing="0" style={{ borderCollapse: "collapse", width: "30px", height: "30px", backgroundColor: "#ecf0f1", borderRadius: "50%" }}>
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style={{ textAlign: "center", verticalAlign: "middle" }}>
                                                                                <img src="https://cdn-icons-png.flaticon.com/512/174/174857.png" width="80%" height="80%" style={{ display: "block", borderRadius: "50%" }} />
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
