...
function Input({ name, type, placeholder, accept = null, register, error }) {
    return (
        <div className="relative z-0 w-full mb-5 group">
            <input type={type} {...register(name)} id={name} className="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" placeholder=" "  accept={accept || undefined} required />
