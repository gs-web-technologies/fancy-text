...
function Input({ name, type, placeholder, register, error }) {
    ...
    if (url_input.includes(name)) {
        return (
            <div className="relative z-0 w-full mb-3 group">
                ...
                })} id={name} className="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" placeholder=" " />
    ...
    return (
        <div className="relative z-0 w-full mb-3 group">
            <input type={type} {...register(name)} id={name} className="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" placeholder=" " />
